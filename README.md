---
title: README for "Assessing Utility of Differential Privacy for RCTs' (Kaitlyn R. Webb, Soumya Mukherjee, Aratrika Mustafi, Aleksandra Slavkovi\'c, Lars Vilhuber)
contributors:
  - Kaitlyn Webb
version: 1.2.rc1
---
...
Alternatively, you can open `DPrct.Rproj` in Rstudio or similar program. 
...
Additionally, we simulate data for analysis. The method of producing this simulated data can be found in `simulations.R`. 
