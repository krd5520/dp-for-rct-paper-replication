...
#'dvs_t2' in AER_1.do
response.vars=c('fam_asb_lt',paste0(c('drugssellever','stealnb','disputes_all_z','carryweapon',
...
liberia.full=readRDS(paste(basepath,"data/liberia_replication_data/LiberiaRound5.Rds",sep="/"))
...
print(cat("Time to replicate: ", time.liberia.rep2b.orig))
attr(liberia.sub,"liberia_replicate_time")=time.liberia.rep2b.orig

saveRDS(liberia.sub,paste(basepath,"data/liberia_replication_data/LiberiaRound5.Rds",sep="/"))
...
###################################################################################
##### Uncomment the following to investigate how to replicate the analysis #####
###################################################################################
#
#                    #Data from:
...
#
# #Change path below to STYL_Final.dta file from replication download
...
#
# #'dvs_t2' in AER_1.do
# response.vars=c('fam_asb','drugssellever','stealnb','disputes_all_z','carryweapon','arrested','asbhostilstd','domabuse_z')
#
